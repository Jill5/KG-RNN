...
def convert_rating():
    ...
    # 把每个user建一个新index（0，1，2，3...），把user_pos_ratings里的item，写入文件ratings_final.txt，格式为：user item 1
    
    # 然后提取一样多的未看过的item，写入文件ratings_final.txt，格式为：user item 0
